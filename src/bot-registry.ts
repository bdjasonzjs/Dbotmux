...
export interface BotConfig {
   ...
   */
  displayName?: string;
  /** Operator-provided description used when cloning an app preset. */
  description?: string;
  /** Base display name of the source bot for stable clone numbering. */
  ...
  /** Per-engine isolated home. Presence is also the persisted clone marker. */
  ...
  for (let i = 0; i < parsed.length; i++) {
    ...
    configs.push({
      ...
      description: typeof entry.description === 'string' && entry.description.trim()
        ...
        : undefined,
      clonedFromName: typeof entry.clonedFromName === 'string' && entry.clonedFromName.trim()
        ? entry.clonedFromName.trim()
        : undefined,
      cliId: entryCliId,
      cliRuntime,
