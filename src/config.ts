...
// Computed once: the production fallback data dir. The effective dir is read
...
const defaultDataDir = join(homedir(), '.botmux', 'data');
...
export const config = {
  ...
  session: {
    get dataDir() { return process.env.SESSION_DATA_DIR ?? defaultDataDir; },
