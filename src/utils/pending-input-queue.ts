...
import type { MaterializedCodexBatch } from '../services/codex-input-batch.js';

export interface PendingCliInput {
  content: string;
  /** Queue-time metadata used only by the Codex immutable backlog batcher. */
  metadata?: PendingInputMetadata;
  enqueuedAt?: number;
  /** Volatile descriptor for a materialized immutable batch stub. */
  codexBatch?: MaterializedCodexBatch;
