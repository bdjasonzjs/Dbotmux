...
export const messages: Record<string, string> = {
  ...
  'card.model.title': '⚙ Model · {cliName}',
  'card.model.current': 'Running: {model}',
  'card.model.cli_default': 'CLI default',
  'card.model.unverified': 'unknown (not verified yet)',
  'card.model.pinned': 'Pinned for this session: {model}',
  'card.model.switching': '🔄 Switching to {target}… (no new switch accepted meanwhile)',
  'card.model.ambiguous': '⚠️ The last switch to {target} timed out with an unknown result; switching is frozen. Recheck or force-rollback.',
  'card.model.fresh_thread_note': 'ℹ️ Switching model on this CLI starts a NEW thread (old thread history is not carried over).',
  'card.model.candidates_live': 'Switchable models (live):',
  'card.model.candidates_static': 'Switchable models (built-in):',
  'card.model.no_candidates': 'This CLI cannot enumerate models; use "Custom" to type a model name.',
  'card.model.effort_title': 'Reasoning effort:',
  'card.model.btn_custom': '✏️ Custom',
  'card.model.btn_refresh': '🔄 Refresh',
  'card.model.btn_recheck': '🔍 Recheck',
  'card.model.btn_force_rollback': '↩ Force rollback',
  'card.model.btn_switch': 'Switch',
  'card.model.btn_confirm_switch': 'Confirm switch (interrupts current turn)',
  'card.model.custom_title': '✏️ Custom model · {cliName}',
  'card.model.custom_note': 'Type a model name and press Switch. Empty = CLI default. An invalid name fails the CLI start and rolls back automatically.',
  'card.model.custom_placeholder': 'e.g. opus / gpt-5.5 / deepseek/deepseek-v4-pro',
  'card.model.confirm_title': '⚠️ Confirm switch · {cliName}',
  'card.model.confirm_busy': '{cliName} is processing a message. Switching to **{target}** restarts the CLI and interrupts the current turn.',
  'card.model.switch_started': '🔄 Switching {cliName} to {target}…',
  'card.model.switch_succeeded': '✅ {cliName} switched to {target}.',
  'card.model.switch_failed': '❌ {cliName} failed to switch to {target}; rolled back to {previous}.',
  'card.model.switch_ambiguous': '⌛ {cliName} switch to {target} timed out, result unknown. Switching is frozen; use Recheck or Force rollback in the model menu.',
  'card.model.effort_dropped': 'ℹ️ Effort {effort} is not available on {model}; fell back to the CLI default.',
  'card.model.refuse.unsupported': 'This CLI does not support switching models.',
  'card.model.refuse.switch_in_flight': 'A switch is in progress; wait for its result.',
  'card.model.refuse.restart_in_flight': 'A restart is in progress; wait for it to finish.',
  'card.model.refuse.ambiguous_frozen': 'The last switch result is unknown; recheck or force-rollback first.',
  'card.model.refuse.effort_not_supported': 'This model does not support that reasoning effort.',
  'card.model.refuse.effort_not_configurable': 'This CLI does not support setting reasoning effort.',
  'card.model.refuse.transferring': 'The session is being transferred; try again later.',
  'card.model.refuse.remote': 'Remote-backend sessions cannot switch models.',
  'card.model.refuse.adopt': 'Adopt-mode sessions cannot switch models.',
  'card.model.refuse.external': 'Only available in chats verified as internal (or DMs).',
  'card.model.refuse.same': 'Already on that model / effort.',
  'card.model.refuse.no_txn': 'No switch pending recheck.',
  'card.model.recheck_committed': '✅ Verified: {cliName} is running {target}.',
  'card.model.recheck_rolled_back': '↩ Recheck found {cliName} still on the previous model; record rolled back.',
  'card.model.recheck_ambiguous': '❓ Still cannot verify the running model (no launch attestation for the new generation). Force-rollback or recheck later.',
  'card.model.invalid_model': 'Invalid model name (letters, digits and . _ - / : only).',
  'card.model.confirm_fresh': 'Switching model on {cliName} starts a **new thread**; the current thread history is not carried into **{target}**. Nothing happens until you confirm.',
  ...
  'card.model.convergence_refused': '⚠️ The process could not be converged back automatically (another restart in flight or a session transfer); /restart manually later.',
  ...
  'card.btn.model_switch': '🎛 Select model',
  'card.model.btn_exit_select': '↩ Exit selection',
  'card.model.btn_switching': '⏳ Switching…',
  'card.model.btn_confirm': 'Confirm switch',
  'card.model.btn_cancel': 'Cancel',
  'card.model.restart_in_flight_note': '⏳ A restart is in progress; switching is available once it finishes (buttons disabled).',
  'card.model.confirm_plain_inline': 'Switch to **{target}**? The CLI restarts (session history kept); the current task continues automatically afterwards.',
  'card.model.confirm_busy_inline': 'Switch to **{target}**? The CLI is processing a message; switching restarts it and interrupts the current turn, then "continue" is sent automatically.',
  'card.model.confirm_fresh_inline': 'Switch to **{target}**? This CLI starts a **new thread** (old thread history is not carried over); "continue" is sent automatically afterwards.',
  'card.model.failed_inline': '❌ Switch to {target} failed: {reason}. Rolled back.',
  'card.model.auto_continue_text': 'continue',
  'card.model.reason_restart_failed': '{cliName} failed to restart with the new model',
  'card.model.custom_not_in_v2': 'Only list selection is supported here.',
  ...
  'ai.shell.how_to_send_report': 'For ordinary in-chat messages, run `botmux send "your message"` via Bash. Attach images with `--images /path`, files with `--files /path`, video previews with `--videos /path.mp4 --video-covers /cover.png`.',
  ...
  'worker.ordinary_recovery_worker_lost': '⚠️ The previous turn was cut off by a daemon restart and automatic continuation did not resume it. Send a message to continue.',
