...
describe('grant gates', () => {
  ...
  it('shares oncall talk access across sibling bots in the bound chat only', () => {
    ...
    expect(canTalk('oncall_scope_b', 'oc_shared_oncall', 'ou_external')).toBe(true);
    expect(canTalk('oncall_scope_b', 'oc_not_oncall', 'ou_external')).toBe(false);
