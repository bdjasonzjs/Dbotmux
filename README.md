...
| 多 CLI 支持 | 5 种 CLI 一键切换（Claude Code / Codex / Cursor / Gemini / OpenCode） | 绑定单一 SDK，无法切换 CLI |
...
- **Node.js** >= 20
- **AI 编程 CLI** 已安装并完成认证（`claude`、`codex`、`cursor-agent`、`gemini` 或 `opencode` 在 PATH 中）
